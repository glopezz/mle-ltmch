...
class DelayModel:
    ...
    def preprocess(
        ...
        if target_column and 'min_diff' in data.columns:
            threshold_in_minutes = 15
            data[target_column] = (data['min_diff'] > threshold_in_minutes).astype(int)
    ...
    def fit(
        ...
        """
        n_y0 = target.value_counts().get(0, 0)
        n_y1 = target.value_counts().get(1, 0)
